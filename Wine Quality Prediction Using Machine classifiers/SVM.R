#Rohith Polishetty 
# Set the environment/workspace through setwd("path-to-workspace") command
# In this example we see the wine quality prediction using Support Vector Machines(SVM)
